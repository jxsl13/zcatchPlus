...
MACRO_CONFIG_INT(SvSqliteWriteInterval, sv_sqlite_write_interval, 12, 5, 600, CFGFLAG_SERVER, "Changes the interval(in seconds) in which the collected data is written to the database. Default: 10 Min: 5 Max: 600 seconds.")
